...
<div class="page-header">
    ...
    <form method="GET" action="index.php" style="display:inline-block; padding:10px; width:auto; text-align:left; margin:0 auto;">
        ...
        <a href="index.php?controller=admin&action=orders" class="btn" style="background:#ddd;">Clear</a>
    </form>
</div>
...
function updateStatus(orderId, newStatus) {
    ...
    // Hit the MVC Router directly
    fetch("index.php?controller=admin&action=updateOrderStatus", {
        method: "POST",
        body: formData
    })
